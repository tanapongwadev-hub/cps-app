/**
 * DepartmentList Container - Logic & State Management
 * 
 ...
 * Container Props
 */
export interface DepartmentListContainerProps {
  className?: string;
}
 ...
 */
export function DepartmentListContainer({ className }: DepartmentListContainerProps) {
  // =========================================================================
  // Auth & Permissions
  // =========================================================================
  const canCreate = useAuthStore((state) =>
    state.hasPermission(PERMISSIONS.DEPARTMENT_CREATE)
  );
