...
export interface MaterialModelFiltersValue {
  search: string;
  isActive?: boolean;
}

export function MaterialModelFilters({
  value,
  onChange,
}: {
  value: MaterialModelFiltersValue;
  onChange: (v: MaterialModelFiltersValue) => void;
}) {
  return (
    <Card className="p-4">
